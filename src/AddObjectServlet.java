...
public class AddObjectServlet extends HttpServlet {
	...
	/**
	 * Using this servlet, user can add object in his/her account. Method first
	 * checks, whether object exists or not, if it does, path is dispatched to
	 * Error, which says: object exists. If it doesn't, Object is being added
	 * and page is being refreshed.
	 * 
